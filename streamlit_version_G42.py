...
# ======================================================================
# Authentication (credentials pulled from st.secrets, never from the repo)
# ======================================================================

# Build the credentials dict expected by streamlit-authenticator directly
# from st.secrets. Locally this reads from .streamlit/secrets.toml (which
# should be in .gitignore); on Streamlit Community Cloud it reads from the
# app's "Secrets" panel in the dashboard settings.
...
# If we reach this point, authentication_status is True
